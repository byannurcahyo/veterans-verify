"""
Veterans Verify - Configuration Management
Complete version, including all environment variable configurations
"""
import os
import random
import threading
...
class Config:
    ...
    def _load_from_env(self):
        ...
        # Persistence
        self._persist_data = os.getenv('PERSIST_DATA', 'true').lower() == 'true'
        ...
        logger.info(f"[Config] Configuration loaded")
    ...
    def _load_email_configs(self):
        ...
        if not self._email_configs:
            logger.warning("[Config] WARNING: Email service not configured!")
